...
const LC0_DEPENDENCIES = [
  ...
  { id: 'tensorflow', url: 'https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@0.14.1/dist/tf.min.js' },
  { id: 'protobuf', url: 'https://cdn.rawgit.com/dcodeIO/protobuf.js/6.8.8/dist/protobuf.min.js' },
];
...
function stop_loop() {
  if (!loop_id) return;
  console.log("clearing id "+loop_id);
...
function start_loop() {
  ...
  console.log("started id "+loop_id);
}
